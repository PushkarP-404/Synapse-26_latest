                ...
                <div className="bg-white/5 p-6 font-poppins md:p-8 rounded">
                    ...
                    <ul className="space-y-3 md:space-y-4 text-xs md:text-sm leading-relaxed">
                        ...
                        <li className="flex gap-2 md:gap-3">
                            ...
                            <span>On 26th February, accommodation will not be provided before 4:00 PM.</span>
                        </li>
                        <li className="flex gap-2 md:gap-3">
                            <span className="text-white/60 flex-shrink-0">6)</span>
                            <span>
                                On 1st March, check-out will be before 9:00 AM. All guests must vacate the accommodation by this
                                time.
                            </span>
                        </li>
                    </ul>
